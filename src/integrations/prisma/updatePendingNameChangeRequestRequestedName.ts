...
type UpdatePendingNameChangeRequestRequestedNameParams = {
	requestId: number;
...
export async function updatePendingNameChangeRequestRequestedName(params: UpdatePendingNameChangeRequestRequestedNameParams) {
